...
function setup(withAudio=false){
 ...
 return {run,progress,context,els,get,texts,sounds,frame,advance:ms=>now+=ms};
}
...
console.log('PASS: 1001 timeline samples, reverse determinism, three locales, reduced motion, five routes, audio opt-in/cooldown/navigation/visibility cleanup');
